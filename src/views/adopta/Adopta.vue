<template>
  ...
  <div class="espacio_trabajo">
    ...
    <div class="col-md-12 d-block d-md-none">
      Aqui es donde deberia ir boton para pantallas pequeñas ----> Nicolas
    </div>
    <div class="row">
      <div class="col-md-3 d-none d-md-block filtroP">
        <!-- Esta es la parte donde se pone el primer menu, desde esta parte se comienza a elegir-->
        <h3 class="colFil">
          <span class="fa fa-search fa-sm"></span> Filtrar por:
        </h3>
        <div class="colFil">
          <h4><span class="fa fa-paw"></span> Tipo de mascota</h4>
          <div class="form-check form-check-inline col-6 offset-1">
            <input
          ...
          <div class="form-check form-check-inline col-6 offset-1">
            <input
              ...
              v-model="tipos"
            />
            <label class="form-check-label" for="bovino">Bovino</label>
          </div>
          <div class="form-check form-check-inline col-6 offset-1">
            <input
              class="form-check-input"
              ...
              v-model="tipos"
            />
            <label class="form-check-label" for="pez">Pez</label>
          </div>
          <div class="form-check form-check-inline col-6 offset-1">
            <input
              class="form-check-input"
              ...
              v-model="tipos"
            />
            <label class="form-check-label" for="roedor">Roedor</label>
          </div>
          <div class="form-check form-check-inline col-6 offset-1">
            <input
              class="form-check-input"
              ...
              v-model="tipos"
            />
            <label class="form-check-label" for="ave">Ave</label>
          </div>
          <div class="form-check form-check-inline col-6 offset-1">
            <input
              class="form-check-input"
              ...
              v-model="tipos"
            />
            <label class="form-check-label" for="equino">Equino</label>
          </div>
          <div class="form-check form-check-inline col-6 offset-1">
            <input
              class="form-check-input"
        ...
        <div class="colFil">
          <h4><span class="fa fa-magic"></span> Esterilidad del animal</h4>
          <div class="form-check form-check-inline col-6 offset-1">
            <input
              class="form-check-input"
              type="radio"
              ...
              v-model="esteril"
            />
            <label class="form-check-label" for="sterile">Si</label>
          </div>
          <div class="form-check form-check-inline col-6 offset-1">
            <input
              class="form-check-input"
              ...
              v-model="esteril"
            />
            <label class="form-check-label" for="sterile">No</label>
          </div>
        </div>
        <div class="colFil">
          <h4>
            <span class="fa fa-mars"></span> Sexo
          ...
          <div class="form-check form-check-inline col-6 offset-1">
            <input
              ...
              v-model="sexo"
            />
            <label class="form-check-label" for="sex">Macho</label>
          </div>
          <div class="form-check form-check-inline col-6 offset-1">
            <input
              class="form-check-input"
              ...
              v-model="sexo"
            />
            <label class="form-check-label" for="sex">Hembra</label>
          </div>
        </div>
        <div class="colFil">
          <h4><span class="fa fa-balance-scale"></span> Tamaño</h4>
          <div class="form-check form-check-inline col-6 offset-1">
            <input
              class="form-check-input"
              type="checkbox"
              name="size"
              id="Muy pequeño"
              value="Muy pequeño (menos de 5 Kg)"
              v-model="tamano"
            />
            <label class="form-check-label" for="Muy pequeño">X Pequeño</label>
          </div>
          <div class="form-check form-check-inline col-6 offset-1">
            <input
              class="form-check-input"
          ...
          <div class="form-check form-check-inline col-6 offset-1">
            <input
              ...
              v-model="tamano"
            />
            <label class="form-check-label" for="Muy Grande">X Grande</label>
          </div>
        </div>
        <div class="colFil">
          <h4><span class="fa fa-flask"></span> Vacunas al día</h4>
          <div class="form-check form-check-inline col-6 offset-1">
            <input
              class="form-check-input"
              type="radio"
              ...
              v-model="vacunas"
            />
            <label class="form-check-label" for="vaccines">Si</label>
          </div>
          <div class="form-check form-check-inline col-6 offset-1">
            <input
              class="form-check-input"
              ...
              v-model="vacunas"
            />
            <label class="form-check-label" for="vaccines">No</label>
          </div>
        </div>
        <button class="btn btn-success filBtn btn-lg" @click="filtrar" type="button">Filtrar</button>
        <button class="btn btn-warning filBtn btn-lg" @click="limpiar" type="button">Limpiar</button>
      </div>
      <div class="row tres_mascotas col-md-9">
        <div
