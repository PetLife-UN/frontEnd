<template >
    <div>
        ...
        <br>
        <div class ="container">
            <p class="texto_recupera_cont">Ingresa tu correo electrónico, enviaremos un email para que puedas cambiar tu contraseña. </p>
        </div>
        <div class="ingresar">
            <div class="orden">
            ...
            <div class="alert alert-success espacio" role="alert" v-if="successSentRecover">
                Revisa tu correo...<br>
